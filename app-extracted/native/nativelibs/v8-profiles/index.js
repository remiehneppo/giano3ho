...
var binding;
try {
  binding = process.platform === 'win32' ? (process.arch === 'ia32' ? require('./profiler_electron1.8_win32_ia32.node') : require('./profiler_electron1.8_win32_x64.node')) : (process.platform === 'darwin' ? require('./profiler_electron1.8_mac.node') : null);
} catch(e) {
  binding = null;
}
if (!binding) {
  // Stub for Linux / unsupported platforms
